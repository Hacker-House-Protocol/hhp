...
Hacker Houses have access filters (required skill tags, required POAPs). The TEE verifies credentials inside the enclave. Output: pass/fail. The wallet is never exposed to the creator or other participants.
...
| "DeFi vault keeping strategy private?" | Staking pool per Hacker House operates as a confidential vault — participants protected from tracking |
...
### In scope
- Smart contract: creator sets up a Hacker House with hidden access requirements (required skill tags, required POAPs)
...
- Organization sponsorship flow (Fase 3)
...
- Platform HHP (profiles, Houses, matching) — already implemented
...
- **[Nombre]** — Role, key skills, relevant experience
- **[Nombre]** — Role, key skills, relevant experience
- **[Nombre]** — Role, key skills, relevant experience
