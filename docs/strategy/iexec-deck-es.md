...
Las Hacker Houses tienen filtros de acceso (skill tags requeridas, POAPs requeridos). El TEE verifica credenciales dentro del enclave. Output: pass/fail. La wallet nunca se expone al creador ni a otros participantes.
...
### En scope
- Smart contract: el creador levanta una Hacker House con requisitos de acceso ocultos (skill tags requeridas, POAPs requeridos)
